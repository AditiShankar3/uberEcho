...
1. Stage 1: Trains and caches Dense FAISS embeddings & calibrated classifier on data/train_pairs.csv.
2. Stage 2: Validates confidence and similarity thresholds on data/val_pairs.csv.
...
def main():
    ...
    # ---------------------------------------------------------
    # STAGE 1: TRAINING ON data/train_pairs.csv
    # ---------------------------------------------------------
    print_banner("STAGE 1 / 3: TRAINING ON data/train_pairs.csv")
    ...
    # ---------------------------------------------------------
    # STAGE 2: VALIDATING ON data/val_pairs.csv
    # ---------------------------------------------------------
    print_banner("STAGE 2 / 3: VALIDATION ON data/val_pairs.csv")
